  ...
  return (
    <section id="servicios" className="section-padding">
      <div className="content-container">
        ...
        <FadeUp delay={0.15}>
          <p className="font-[family-name:var(--font-instrument-sans)] text-rl3-gray text-lg mb-16 max-w-2xl leading-[1.7]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PILLARS.map((pillar, i) => (
            <FadeUp key={pillar.number} delay={0.1 + i * 0.15}>
              <div className="group relative h-full bg-rl3-dark-gray border border-rl3-mid-gray p-8 md:p-10 transition-all duration-300 hover:border-rl3-accent/30 hover:bg-rl3-dark-gray/80">
                {/* Gold top border on hover */}
                <div className="absolute top-0 left-0 right-0 h-0.5 bg-rl3-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />

                <span className="block font-[family-name:var(--font-space-mono)] text-5xl font-bold text-rl3-mid-gray group-hover:text-rl3-accent transition-colors duration-300">
                  {pillar.number}
                </span>
                ...
                <p className="font-[family-name:var(--font-instrument-sans)] text-rl3-gray leading-[1.7] mb-6 text-sm">
                  {pillar.description}
                </p>
                ...
                <ul className="space-y-2.5">
                  {pillar.features.map((feature) => (
                    ...
                    >
                      <span className="text-rl3-accent mt-0.5 shrink-0">→</span>
                      {feature}
                    </li>
                  ))}
                </ul>
